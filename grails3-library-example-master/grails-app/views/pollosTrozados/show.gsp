...
<div id="show-pollosTrozados" class="content scaffold-show" role="main">
    <h1><g:message code="default.show.label" args="[entityName]" /></h1>
    <g:if test="${flash.message}">
        <div class="message" role="status">${flash.message}</div>
    </g:if>
    <div class="form-horizontal">
        <f:display bean="pollosTrozados" />
    </div>
    <g:form resource="${this.pollosTrozados}" method="DELETE">
        <div class="clearfix form-actions">
            <div class="col-md-offset-3 col-md-9">
                <g:link class="btn btn-primary" action="edit" resource="${this.pollosTrozados}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
